...
class ProgressActionClient: public rclcpp::Node
{
  public:
    ...
    {
      service_ = this->create_service<AddInts>("add_Ints", std::bind(&ProgressActionClient::add, this, _1, _2));
...
int main(int argc, char ** argv)
{
  ...
  rclcpp::spin(std::make_shared<ProgressActionClient>());//持续处理传入节点的所有回调
  //5，释放资源
  rclcpp::shutdown();
  return 0;
}